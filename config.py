...
PROJECT_ID = 'valiant-sanctum-231204'
...
MONGO_URI = 'mongodb+srv://user0:password1995@cluster0-nfpmn.gcp.mongodb.net/image_classification_flask'
...
CLOUD_STORAGE_BUCKET = 'image_classification_flask'
